...
exports.checkAnswer = exports.generateProblems = void 0;
const openai_1 = __importDefault(require("../config/openai"));
// @desc    Generate practice problems
// @route   POST /api/ai/generate-problems
// @access  Private
const generateProblems = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
Student: "${userAnswer}"`
        ...
        res.status(200).json(Object.assign({ success: true }, evaluation));
    }
    catch (error) {
